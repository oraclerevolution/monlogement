...
<head>
    ...
    <!-- Title  -->
    <title>MonLogement | Résultats</title>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Résultats</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="listings-top-meta d-flex justify-content-between mb-100">
                        ...
                        <div class="order-by-area d-flex align-items-center">
                            <span class="mr-15">Trier par:</span>
                            <select>
                              <option selected>par défaut</option>
                              <option value="1">ajouts récents</option>
                              <!--<option value="2">Sales</option>
                              <option value="3">Ratings</option>-->
                              <option value="3">Populaires</option>
                            </select>
                        </div>
                    </div>
                </div>
