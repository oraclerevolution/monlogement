...
<head>
    ...
    <!-- Title  -->
    <title>MonLogement | Récuperer votre mot de passe</title>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Récuperez votre mot de passe</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="contact-heading">
                        <h6>Récuperez votre mot de passe</h6>
                    </div>
                </div>
            </div>
                ...
                <!--<div class="col-12 col-lg-8">
                    <div class="contact-form">
                        <form action="#" method="post">
                            ...
                            <!--<div class="form-group">
                                <input type="name" class="form-control" name="name" id="contact-name" placeholder="Votre Nom">
                            </div>
							<div class="form-group">
                                <input type="name" class="form-control" name="name" id="contact-name" placeholder="Vos prenoms">
                            </div>-->
							<div class="form-group">
                                <input type="user" class="form-control" name="user" id="contact-email" placeholder="Saisissez votre adresse e-mail">
                            </div>
							<!--<div class="form-group">
                                <input type="password" class="form-control" name="password" id="password" placeholder="Entrez un mot de passe">
                            </div></br>-->
							<!--<div class="form-group">
                                <input type="password" class="form-control" name="password" id="password" placeholder="Entrez de nouveau le mot de passe">
                            </div>-->
                            <!--<div class="form-group">
							...
							<i><p>*Saisissez votre adresse e-mail et cliquez sur "Envoyer"</br>
							<p>*Suivez les instructions dans l'e-mail de vérification qui va vous être envoyé.<br>
							<p>*Si vous ne le recevez pas dans l'email, vérifiez votre dossiers "courrier indésirable" et/ou "Spam" sur votre boîte email.<br>
							<p>*Si l'email n'est pas dans le dossiers spam, contactez-nous via le formulaire <a align="right" href="contact.html">Nous contacter<a><br><i>
