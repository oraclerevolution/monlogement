...
<head>
    ...
    <!-- Title  -->
    <title>MonLogement | Connexion</title>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">CONNEXION</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <!--<div class="col-12 col-lg-8">
                    <div class="contact-form">
                        <form action="#" method="post">
							...
							<div class="form-group">
                                <input type="user" class="form-control" name="user" id="contact-email" placeholder="Entrez votre E-mail">
                            </div>
							<div class="form-group">
                            ...
                            <button type="submit" class="btn south-btn">Se connecter</button>
							<i><p>Vous avez oublié votre mot de passe ? <a align="right" href="motdepasseoublie.html">Cliquez Ici<a>
							<p>Vous ne possédez pas de compte ? <a align="right" href="inscription.html">Inscrivez-vous<a><i>
                    ...
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="footer-widget-area mb-100">
                            ...
                            <ul class="useful-links-nav d-flex align-items-center">
                                ...
                                <li><a href="#">Déposer une Annonces</a></li>
                                <li><a href="#">Blog</a></li>
