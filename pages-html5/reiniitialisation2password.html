...
<head>
    ...
    <!-- Title  -->
    <title>MonLogement | Réinitialisation</title>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Réinitialisation</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-8">
                    <div class="contact-form">
                        <form action="#" method="post">
							...
							<div class="form-group">
                                <input type="password" class="form-control" name="password" id="password" placeholder="Entrez un nouveau mot de passe">
                            </div>
							<div class="form-group">
                                <input type="password" class="form-control" name="password" id="password" placeholder="Confirmez le nouveau mot de passe">
                            </div>
							
                            <!--<div class="form-group">
                                <textarea class="form-control" name="message" id="message" cols="30" rows="10" placeholder="Votre Message"></textarea>
                            </div>-->
                            <button type="submit" class="btn south-btn">Réinitialiser</button>
                        </form>
                    </div>
                </div>
            </div>
