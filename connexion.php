        ...
        <div class="top-header-area">
            <div class="h-100 d-md-flex justify-content-between align-items-center">
                <div class="email-address">
                    <a href="monlogement@contact">monlogement@contact.com</</a>
                </div>
                <div class="phone-number d-flex">
                    ...
                    <div class="number">
                        <a href="tel:+225 77263430">+225 772 634 30</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-8">
                    <div class="contact-form">
                        <div class="form-group">
							...
							<p>Vous avez oublié votre mot de passe ? <a href="motdepasseoublie.html">Cliquez Ici !   <a>Vous ne possédez pas de compte ? <a href="inscription.html">Inscrivez-vous<a><i>
