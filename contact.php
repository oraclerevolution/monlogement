...
<head>
    ...
    <!-- Title  -->
    <title>MonLogement | Contact</title> -->
                    ...
                    <div class="contact-form">
                        <form action="#" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" name="text" id="contact-name" placeholder="Votre nom et prénoms">
                            </div>
                            <div class="form-group">
							...
							<div class="form-group">
                                <input type="text" class="form-control" name="objet" id="contact-objet" placeholder="objet">
                            </div>
                            <div class="form-group">
